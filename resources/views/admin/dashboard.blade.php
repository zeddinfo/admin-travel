...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{url('asset/sdist/img/user8-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/armada')}}" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="#">NUWOVIN TECH</a>(Template By Admin LTE 3)</strong>
    All rights reserved.
...
<script src="{{url('assets/sdist/js/demo.js')}}"></script>
